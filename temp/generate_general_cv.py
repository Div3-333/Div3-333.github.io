...
# ---------- content ----------
# REMOVED PALO ALTO SPECIFIC MENTION
summary = "Cybersecurity and Data Science student at Monash University. Experienced in leading infrastructure migrations, executing white-box penetration tests, and translating technical risk into commercial impact. Proven ability to bridge computational rigor with structural pattern recognition. Seeking to apply specialized expertise in high-stakes environments where technical integrity and data-driven security are paramount."
